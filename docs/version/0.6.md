...
# FFF Flavored Frontmatter <br /> Version 0.6 (Draft)
...
- Add: [`alt`](#alt)
- Improve: [`lang`](#lang) support arrays
...
::: info
This is a fallback for Object Media `(image || audio || video).alt`, which should be converted automatically by the plugin.
:::

- type: `string`
- description: media alternate text.
